...
export class CtznEditorHTMLBlockMenu extends LitElement {
  ...
  renderBlockTagOption (tagName, icon, label) {
    const setBlockTag = (tagName) => this.dispatchEvent(new CustomEvent('set-html-block-tag', {detail: {tagName}, bubbles: true}))
    return html`
      <div
        class="dropdown-item"
...
customElements.define('ctzn-editor-html-block-menu', CtznEditorHTMLBlockMenu)